...
__all__ = ['BaseObject', # base class for topogy, store tolerance
           ]
...
from .Common import get_boundingbox, minimum_distance
...
class BaseObject(object):
    ...
    def show(self, *args, **kwargs):
        ...
        if not self.display_set:
            ...
            raise Exception('not found self.display_set')
        else:
