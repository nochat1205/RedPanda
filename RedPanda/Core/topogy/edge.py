...
__all__ = [
    'EdgeAnalyst', # combine all function of edge
           ]
...
from ..Euclid import RP_Vec, RP_Dir, RP_Pnt
...
class EdgeAnalyst(TopoDS_Edge, BaseObject):
    ...
    def trim(self, lbound, ubound):
        ...
        return EdgeAnalyst(make_edge(tr))
